...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@angular/core/testing", "@angular/http/testing", "@angular/http", "rxjs/add/observable/of", "rxjs/add/operator/catch", "rxjs/add/operator/do", "rxjs/add/operator/toPromise", "./text-msg-it-api.service", "./text-msg-it-auth.service", "./text-msg-it-auth-service-config", "./core-api.service", "./core-auth.service", "./core-auth-service-config"], factory);
    }
